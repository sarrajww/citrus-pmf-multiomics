...
def page_findings():
    ...
    with dtab1:
        df = load_csv("data/expression_matrix.csv", _mtime("data/expression_matrix.csv"))
        st.dataframe(df, use_container_width=True, hide_index=True)
        st.caption("Mock data — schema: gene_id, gene_name, annotation, [sample columns], module, r_nobiletin, r_tangeretin")

    with dtab2:
        df = load_csv("data/metabolite_table.csv", _mtime("data/metabolite_table.csv"))
        st.dataframe(df, use_container_width=True, hide_index=True)
    ...
    with dtab3:
        df = load_csv("data/candidate_genes.csv", _mtime("data/candidate_genes.csv"))
        st.dataframe(df, use_container_width=True, hide_index=True)
...
def page_resources():
    ...
    with dl_col1:
        df_exp = load_csv("data/expression_matrix.csv", _mtime("data/expression_matrix.csv"))
    ...
    with dl_col2:
        df_met = load_csv("data/metabolite_table.csv", _mtime("data/metabolite_table.csv"))
    ...
    with dl_col3:
        df_cand = load_csv("data/candidate_genes.csv", _mtime("data/candidate_genes.csv"))
